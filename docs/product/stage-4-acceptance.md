...
- 同文档、同主题和同答案版本的最多 3 个 chunk 可受控聚合，并保留独立引用与逐证据注入检查。

## 2. 验收证据

- 80 场景：80/80 通过，Intent macro-F1 1.0000，安全升级 Recall 1.0000；
...
- 多证据合并只支持同文档、同主题、同答案版本且最多 3 个 chunk，不会跨文档自由生成结论；
